                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="nama" id="nama" placeholder="" value="{{ $object->nama }}" required="">
                        </div>
                      </div>
                    </div>
                    <!--/.row-->
                    ...
                    <div class="row">
                      <div class="col-sm-12">
                        <div class="form-group">
                          ...
                          <textarea class="form-control" id="deskripsi" name="deskripsi" placeholder="" rows="10">{{ $object->deskripsi }}</textarea>
                        </div>
                      </div>
                    </div>
                    <!--/.row-->
...
@section('footer-script')
      <script type="text/javascript">
        ...
        $("#form").on('submit', function(e){
            ...
            $.ajax({
               type:'PUT',
               url:'{{ url("api/level/update/".$object->id) }}',
