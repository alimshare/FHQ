            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-header">
                  <i class="fa fa-align-justify"></i> List Pembelian
                  <div class="pull-right">
                    <a href="{{ url('pembelian/export') }}" class="btn btn-success" title="Export CSV"> <i class="fa fa-file-excel-o"></i> Export</a>
                    <a href="{{ url('pembelian/add') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add</a>
                  </div>
                </div>
                <div class="card-body">
    ...
    if ($('.datatable').length > 0) {
      $('.datatable').DataTable();
        ...
        $("#form").on('submit', function(e){
            ...
            $.ajax({
               type:'DELETE',
               url:'{{ url("api/pembelian/remove") }}/'+id,
