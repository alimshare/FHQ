        ...
        <ul class="nav">
          ...
          <li class="nav-item nav-dropdown">
            ...
            <ul class="nav-dropdown-items">
              <li class="nav-item"><a class="nav-link" href="santri"><i class="icon-user"></i> Santri </a></li>
          ...
          <li class="nav-item">
            <a class="nav-link" href="peserta"><i class="icon-people"></i> Peserta </a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="infaq"><i class="icon-calculator"></i> Infaq </a>
          </li>
